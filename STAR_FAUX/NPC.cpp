...
NPC::NPC(int iff, Shape3D *S, Path *P)
{
	this->iff = iff;
	targetShape = S;
	targetPath = P;
...
void NPC::update(GLfloat inc, std::deque<Projectile> *projectileList, GLfloat playerPosition[3], int* player_kills) //maybe .06???
{
	if (this->health > 0)
	{
