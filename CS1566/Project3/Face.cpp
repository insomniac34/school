...
{
	printf("\nVertices contained within this face: \n");
	//WARNING: CAUSING MEMORY ACCESS VIOLATIONS
	//printf("%g, %g, %g, %g\n", facepoint0->x, facepoint0->y, facepoint0->z, facepoint0->w);
	printf("\n");
}
...
//THE FOLLOWING WERE CALCULATED VIA TRACING ON PAPER
Vertex Face::getFP0()
{
