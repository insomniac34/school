...
public:
	...
	Path(Vertex, Vertex, Vertex[], int); //accepts a STARTPOINT, an ENDPOINT, and an array of size N filled with vertices to be used as a series of waypoints IN BETWEEN the designated start/end points
	~Path();
