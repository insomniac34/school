...
GLdouble** matrixMult(GLdouble[][4], const GLdouble[][4]);
...
GLdouble* vectorMatrixMult(vec3, GLdouble[4][4]);

GLdouble* vectorMatrixMult(Vertex, GLdouble**);

GLdouble* vectorMatrixMult(vec3, GLdouble**);
