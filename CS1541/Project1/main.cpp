...
@Description: Original code supplied for assignment but modified to ensure compatibility with C++ Pipeline API
...
int main(int argc, char **argv)
{
  ...
  if (argc == 5)myPipeline = Pipeline(atoi(argv[2]), atoi(argv[3]), atoi(argv[4]));
  else myPipeline = Pipeline(0, 0, 128);
